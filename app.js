            ...
            div.innerHTML = `
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"><span class="fw-bold text-secondary">Authors: </span>${book.author_name}</p>
                        <p class="card-text text-muted">Publisher: ${book.publisher}</p>
                        <p class="card-text text-muted">First Published: ${book.first_publish_year}</p>
                    </div>
                </div>
            `;
            searchResult.appendChild(div);
